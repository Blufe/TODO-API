...
GRANT Select,Update,Insert,Delete ON TODODB.* TO SCI01449 IDENTIFIED BY 'DBPW#0511loki';
GRANT Select,Update,Insert,Delete ON TODODB.* TO SCI01449@localhost IDENTIFIED BY 'DBPW#0511loki';
